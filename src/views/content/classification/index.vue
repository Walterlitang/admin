        ...
        <div class="container">
          <el-form inline size="small" @submit.native.prevent>
            ...
            <el-form-item class="el-form-item-align-right">
              <el-button icon="el-icon-circle-plus" size="mini" type="primary" @click="openEdit(null,null)" v-has-permi="['admin:classification:save']">添加
              </el-button>
            </el-form-item>
          </el-form>
        </div>
        ...
        <el-table-column label="操作" min-width="180" fixed="right" align="center">
          <template slot-scope="scope">
            <el-button
                ...
                v-has-permi="['admin:classification:save']">
              添加子级
            </el-button>
            <el-button
                icon="el-icon-edit"
                size="mini"
                type="text"
                @click="openEdit(scope.row.id,null)"
                v-has-permi="['admin:classification:save']">
              编辑
            </el-button>
<!--            <el-button-->
...
<!--                v-has-permi="['admin:system:category:delete']"-->
...
import {getTree,deleteRow,updateStatus} from "@/api/classification";
